  ...
  (* Print an error message *)
    ...
    BEGIN
      ...
      CASE nr OF
         ...
         6 : Msg('"," expected');
         7 : Msg('"REPEAT" expected');
         8 : Msg('"otherstatement" expected');
         9 : Msg('"UNTIL" expected');
        10 : Msg('"CONDITION" expected');
        11 : Msg('"FOREVER" expected');
        12 : Msg('"IF" expected');
        13 : Msg('"THEN" expected');
        14 : Msg('"ELSE" expected');
        15 : Msg('"ENDIF" expected');
        16 : Msg('"END" expected');
        17 : Msg('not expected');
        18 : Msg('invalid ifTail');
        19 : Msg('invalid statement');
        20 : Msg('invalid tailRepeatStatement');
        21 : Msg('invalid list');
