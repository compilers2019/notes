...
USES LangS, (* lst, src, errors, Error, CharAt *)
     LangP;  (* Parse, Successful *)
  ...
  (* Print an error message *)
    ...
    BEGIN
      ...
      CASE nr OF
        ...
        21 : Msg('"IS" expected');
        22 : Msg('not expected');
        23 : Msg('invalid MulOperator');
        24 : Msg('invalid factor');
        25 : Msg('invalid AddOperator');
        26 : Msg('invalid relation');
